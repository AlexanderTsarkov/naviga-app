...
| 88 | [#88](https://github.com/AlexanderTsarkov/naviga-app/issues/88) Core UI screens (Connect/My Node/Nodes/Details) | **Done** | [#111](https://github.com/AlexanderTsarkov/naviga-app/pull/111) | `app/lib/features/`, `app/lib/shared/` | analyze; test; run (screens + data) | connect UX and core screens wired per Mobile v1 scope |
| 89 | [#89](https://github.com/AlexanderTsarkov/naviga-app/issues/89) Map v1 (flutter_map + markers) | **Done** | [#125](https://github.com/AlexanderTsarkov/naviga-app/pull/125) | `app/lib/features/map/` | analyze; test; run (markers) | Online tiles only (no offline) |
| 90 | [#90](https://github.com/AlexanderTsarkov/naviga-app/issues/90) Settings v1 (about + diagnostics) | **Done** | [#126](https://github.com/AlexanderTsarkov/naviga-app/pull/126) | `app/lib/features/settings/` | analyze; test; run | No BLE config in v1 |
...
| [#11](https://github.com/AlexanderTsarkov/naviga-app/issues/11) | 1.2 Firmware architecture | Doc + steps 11.1–11.4 | Done | PRs #51/#52/#53/#55; checklist steps 11.1–11.4 delivered via these PRs; issue closed after implementation completion (prior Partial status was tracking lag). |
...
| [#21](https://github.com/AlexanderTsarkov/naviga-app/issues/21) | 2.3 HAL radio driver | Code | Done | PR [#59](https://github.com/AlexanderTsarkov/naviga-app/pull/59) — E220 PING/PONG confirmed on two ESP32-S3 boards; see `docs/firmware/stand_tests/issue_21_smoke_test_pr59_results.md`. |
...
| [#28](https://github.com/AlexanderTsarkov/naviga-app/issues/28) | 3.1 App module structure | App | Done | Closed as superseded by Epic [#80](https://github.com/AlexanderTsarkov/naviga-app/issues/80) (Mobile v1); implementation lives in `app/lib/app/` and `app/lib/features/*` under Mobile v1 PRs. |
| [#29](https://github.com/AlexanderTsarkov/naviga-app/issues/29) | 3.2 BLE client + contract | App | Done | Closed as superseded by Epic [#80](https://github.com/AlexanderTsarkov/naviga-app/issues/80) (Mobile v1); implementation lives in `app/lib/features/connect/` and related Mobile v1 PRs. |
| [#30](https://github.com/AlexanderTsarkov/naviga-app/issues/30) | 3.3 Domain model (Node/NodeTable) | App | Done | Closed as superseded by Epic [#80](https://github.com/AlexanderTsarkov/naviga-app/issues/80) (Mobile v1); implementation lives in `app/lib/features/nodes/` and Mobile v1 PRs. |
| [#31](https://github.com/AlexanderTsarkov/naviga-app/issues/31) | 3.4 Node list screen | App | Done | Closed as superseded by Epic [#80](https://github.com/AlexanderTsarkov/naviga-app/issues/80) (Mobile v1); implementation lives in Connect/Nodes screens under Mobile v1 PRs. |
| [#32](https://github.com/AlexanderTsarkov/naviga-app/issues/32) | 3.5 Map + “me” | App | Done | Closed as superseded by Epic [#80](https://github.com/AlexanderTsarkov/naviga-app/issues/80) (Mobile v1); implementation lives in `app/lib/features/map/` (Map tab) under Mobile v1 PRs. |
| [#33](https://github.com/AlexanderTsarkov/naviga-app/issues/33) | 3.6 Local log | App | Done | Closed as superseded by Epic [#80](https://github.com/AlexanderTsarkov/naviga-app/issues/80) (Mobile v1); implementation lives in logging/telemetry surfaces in Mobile v1 PRs. |
| [#34](https://github.com/AlexanderTsarkov/naviga-app/issues/34) | 3.7 App integration/E2E test | App | Done | Closed as superseded by Epic [#80](https://github.com/AlexanderTsarkov/naviga-app/issues/80) (Mobile v1); coverage now lives in Mobile v1 integration/E2E flows. |
| [#35](https://github.com/AlexanderTsarkov/naviga-app/issues/35) | 4.1 Field test 2–5 nodes | Test | Done | Closed after real 2–5 node field test per Test Plan v0; results captured in field test report (see OOTB v0 analysis/plan docs). |
