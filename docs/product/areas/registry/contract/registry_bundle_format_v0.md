...
- **registries:** Keyed by same `id` as in `contents`. Values are arrays of entries (structure per [registry_hw_capabilities_v0](../../../wip/areas/hardware/registry_hw_capabilities_v0.md), [registry_radio_profiles_v0](../../../wip/areas/radio/registry_radio_profiles_v0.md), etc.). References (IDs used elsewhere, e.g. in NodeTable or selection policy) are the stable ids inside these arrays.
...
- **HW registry:** [registry_hw_capabilities_v0](../../../wip/areas/hardware/registry_hw_capabilities_v0.md) — semantics of hwProfiles entries.
