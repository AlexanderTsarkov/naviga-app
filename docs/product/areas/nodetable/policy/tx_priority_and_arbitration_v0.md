# NodeTable — TX priority & queue arbitration v0
...
This document defines the **v0 intent** for TX priority levels, coalesce keys, and hybrid expired-counter semantics for NodeTable-related beacon packets. It does **not** modify existing v0 canon encoding contracts; it describes policy for queue arbitration and send eligibility.
...
- v0 canon ([field_cadence_v0](field_cadence_v0.md), [beacon_payload_encoding_v0](../contract/beacon_payload_encoding_v0.md)) defines **what** is sent (Core / Tail-1 / Tail-2 / Informative) and byte layout. This doc defines **when** and **in what order** within a v0.1 TX policy.
...
- [identity_naming_persistence_eviction_v0.md](identity_naming_persistence_eviction_v0.md) — S03 Identity/Naming + Persistence/Eviction block (frozen).
- [packet_sets_v0.md](packet_sets_v0.md) — Packet definitions v0 and eligibility rules.
