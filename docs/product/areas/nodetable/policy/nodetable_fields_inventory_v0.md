...
| **nodeId** | NodeID48 (6-byte LE MAC48); primary key, WHO. See [nodeid_policy_v0](../../identity/nodeid_policy_v0.md). | [beacon_payload_encoding_v0.md](../contract/beacon_payload_encoding_v0.md) §3.1, [index.md](../index.md) §3 | Identity | Sent | Uncoupled | No | A | every beacon tick | BeaconCore | 6 | On-air: 6 bytes LE (NodeID48). Domain: uint64 lower 48 bits. |
| **positionLat** (`lat_u24`) | Latitude packed24 (WGS84); WHERE. On-air: uint24 LE, `round((lat+90)/180×16777215)`. Domain: decoded to float/double. See [beacon_payload_encoding_v0.md §4.1](../contract/beacon_payload_encoding_v0.md). | [beacon_payload_encoding_v0.md](../contract/beacon_payload_encoding_v0.md) §4.1, [index.md](../index.md) §6 | Position | Sent | Attached-to-Core | Yes | A | every beacon tick when position valid | BeaconCore | 3 | Must ride with Core in v0. `pos_valid`/`pos_age_s` are NOT part of BeaconCore; see §4.2 Tail-1. Decision: [#301](https://github.com/AlexanderTsarkov/naviga-app/issues/301). |
| **positionLon** (`lon_u24`) | Longitude packed24 (WGS84); WHERE. On-air: uint24 LE, `round((lon+180)/360×16777215)`. Domain: decoded to float/double. See [beacon_payload_encoding_v0.md §4.1](../contract/beacon_payload_encoding_v0.md). | [beacon_payload_encoding_v0.md](../contract/beacon_payload_encoding_v0.md) §4.1, [index.md](../index.md) §6 | Position | Sent | Attached-to-Core | Yes | A | every beacon tick when position valid | BeaconCore | 3 | Must ride with Core in v0. Decision: [#301](https://github.com/AlexanderTsarkov/naviga-app/issues/301). |
...
| **ShortId** | Display id derived from NodeID48; CRC16-CCITT-FALSE over 6-byte LE NodeId; may collide. See [nodeid_policy_v0](../../identity/nodeid_policy_v0.md) §4. | [index.md](../index.md) §3, [nodeid_policy_v0](../../identity/nodeid_policy_v0.md) §4 | Identity | Derived | Uncoupled | No | — | — | — | 2 | Derived local display only; not sent in v0. Reserved values 0x0000/0xFFFF: see [nodeid_policy_v0](../../identity/nodeid_policy_v0.md) §4 (normative rule). MUST NOT be used as protocol key. |
