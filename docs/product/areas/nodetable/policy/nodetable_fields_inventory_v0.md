...
| **ShortId** | Display id derived from NodeID48; CRC16-CCITT-FALSE over 6-byte LE NodeId; may collide. See [nodeid_policy_v0](../../identity/nodeid_policy_v0.md) §4. | [index.md](../index.md) §3, [nodeid_policy_v0](../../identity/nodeid_policy_v0.md) §4 | Identity | Derived | Uncoupled | No | — | — | — | 2 | Derived local display only; not sent in v0. Reserved values 0x0000/0xFFFF: substitute XOR 0x0001. MUST NOT be used as protocol key. |
