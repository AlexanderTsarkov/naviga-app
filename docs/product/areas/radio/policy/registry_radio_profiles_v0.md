...
- **Rationale:** Keeps UX simple and avoids invalid combinations; mapping from profile to actual air parameters is firmware/stack responsibility and may depend on **adapter_type** and **HW capabilities** (see [HW registry](../../hardware/contract/registry_hw_capabilities_v0.md)).
...
- **SelectionPolicy:** Contains **choice rules** — default profile/channel, throttling under load, user-facing effects/advice. See [selection_policy_v0.md](../../../wip/areas/radio/selection_policy_v0.md). Autopower algorithm remains a separate follow-up.
...
- **SelectionPolicy:** Choice rules (defaults, throttling, user advice) are in [selection_policy_v0.md](../../../wip/areas/radio/selection_policy_v0.md).
- **AutoPower policy:** Node-side tx power adjustment within user bounds; see [autopower_policy_v0.md](../../../wip/areas/radio/autopower_policy_v0.md) ([#180](https://github.com/AlexanderTsarkov/naviga-app/issues/180)).
- **Channel discovery:** See [channel-discovery-selection-v0.md](../../../wip/areas/radio/policy/channel-discovery-selection-v0.md) ([#175](https://github.com/AlexanderTsarkov/naviga-app/issues/175)) for local scan and future backend heatmap; registry defines compatibility, not discovery flow.
...
- **SelectionPolicy:** [selection_policy_v0.md](../../../wip/areas/radio/selection_policy_v0.md).
- **AutoPower policy:** [autopower_policy_v0.md](../../../wip/areas/radio/autopower_policy_v0.md) — [#180](https://github.com/AlexanderTsarkov/naviga-app/issues/180).
- **Registry distribution & ownership:** [distribution_ownership_v0.md](../../registry/policy/distribution_ownership_v0.md) — [#184](https://github.com/AlexanderTsarkov/naviga-app/issues/184).
- **NodeTable contract:** [nodetable/index.md](../../nodetable/index.md) — [#147](https://github.com/AlexanderTsarkov/naviga-app/issues/147).
- **Channel discovery & selection (stub):** [channel-discovery-selection-v0.md](../../../wip/areas/radio/policy/channel-discovery-selection-v0.md) — [#175](https://github.com/AlexanderTsarkov/naviga-app/issues/175).
