...
- **S03 Provisioning baseline (assembly):** [provisioning_baseline_v0](provisioning_baseline_v0.md) ([#385](https://github.com/AlexanderTsarkov/naviga-app/issues/385)) — what/where/when/fallback and consumers; epic [#353](https://github.com/AlexanderTsarkov/naviga-app/issues/353).
- **fwVersionId semantics and registry:** [fw_version_id_semantics_v0](fw_version_id_semantics_v0.md) ([#405](https://github.com/AlexanderTsarkov/naviga-app/issues/405)), [fw_version_id_registry_v0](../registry/fw_version_id_registry_v0.md) — build identity, uint16 LE, sentinel; human labels for display.
- **hwProfileId semantics and registry:** [hw_profile_id_semantics_v0](hw_profile_id_semantics_v0.md) ([#406](https://github.com/AlexanderTsarkov/naviga-app/issues/406)), [hw_profile_id_registry_v0](../registry/hw_profile_id_registry_v0.md) — hardware config identity, uint16 LE, sentinel; human labels and implied attributes for display.
