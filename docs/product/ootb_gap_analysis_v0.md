...
- **Future:** добавить измерение по ADC + калибровка + отчёт в BLE + power profiling (оценка бюджета по режимам). Владелец темы — [#46](https://github.com/AlexanderTsarkov/naviga-app/issues/46) (см. [workmap](../../_archive/ootb_v1/project/ootb_workmap.md) § 4 Future / Deferred).
...
- **Seed scope:** out of scope; document as **planned work** (Phase 2+). См. [workmap](../../_archive/ootb_v1/project/ootb_workmap.md) § 4 Future / Deferred и issue по ownership & pairing (TBD).
