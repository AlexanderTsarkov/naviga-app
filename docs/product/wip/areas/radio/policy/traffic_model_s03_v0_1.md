# Radio — Traffic model S03 v0.1 (preliminary calculations)

**Status:** WIP. Preliminary, assumption-driven. **Issue:** [#360](https://github.com/AlexanderTsarkov/naviga-app/issues/360) · **Umbrella:** [#351](https://github.com/AlexanderTsarkov/naviga-app/issues/351).

This doc records **preliminary traffic-model calculations** and product conclusions: estimated channel utilization (U) for representative scenarios, why the Core_Pos + Tail split can overload the channel, comparison of mitigation levers, and a control-policy outline. **Purpose:** decision support for S03 planning and future implementation; not a calibrated link budget. All numbers are assumption-based; ±10–15% variation is expected. No packet format redesign; merge is documented as an optional future optimization.

**References:** [packet_to_nodetable_mapping_s03](../../nodetable/policy/packet_to_nodetable_mapping_s03.md), [gnss_tail_completeness_and_budgets_s03](../../nodetable/contract/gnss_tail_completeness_and_budgets_s03.md), [radio_profiles_model_s03](radio_profiles_model_s03.md), [radio_user_settings_review_s03](radio_user_settings_review_s03.md), [tx_priority_and_arbitration_v0_1](../../nodetable/policy/tx_priority_and_arbitration_v0_1.md), [packet_sets_v0_1](../../nodetable/policy/packet_sets_v0_1.md), [field_cadence_v0](../../../../areas/nodetable/policy/field_cadence_v0.md), [traffic_model_v0](traffic_model_v0.md).
...
Label explicitly as **assumption**; real cadence from [field_cadence_v0](../../../../areas/nodetable/policy/field_cadence_v0.md) and role/profile may differ.
...
|-------|--------|-------------------|
| **1) P3 expiry/priority** | Under load, P3 (Operational, Informative) are dropped first; Core_Pos and Alive preserved. | Local fairness; presence/map stay working; battery/uptime/config updates may lag or be lost. See [tx_priority_and_arbitration_v0_1](../../nodetable/policy/tx_priority_and_arbitration_v0_1.md). |
...
| **4) Faster radio profile (rate_tier / SF8 concept)** | Shorter airtime per byte (e.g. higher rate or lower SF). | Lowers U for same packet count; **reduces link margin**; range/sensitivity trade-off. See [radio_profiles_model_s03](radio_profiles_model_s03.md), [e220_radio_profile_mapping_s03](e220_radio_profile_mapping_s03.md). |
...
- **References:** Link back to [packet_to_nodetable_mapping_s03](../../nodetable/policy/packet_to_nodetable_mapping_s03.md), [gnss_tail_completeness_and_budgets_s03](../../nodetable/contract/gnss_tail_completeness_and_budgets_s03.md), [field_cadence_v0](../../../../areas/nodetable/policy/field_cadence_v0.md), [traffic_model_v0](traffic_model_v0.md) (frame limits, delivery expectations).
...
| [packet_to_nodetable_mapping_s03](../../nodetable/policy/packet_to_nodetable_mapping_s03.md) | Packet types and field mapping. |
| [gnss_tail_completeness_and_budgets_s03](../../nodetable/contract/gnss_tail_completeness_and_budgets_s03.md) | Tail semantics; Core/Tail split fixed. |
| [radio_profiles_model_s03](radio_profiles_model_s03.md) | rate_tier, profile model. |
| [radio_user_settings_review_s03](radio_user_settings_review_s03.md) | Radio settings in product terms. |
| [tx_priority_and_arbitration_v0_1](../../nodetable/policy/tx_priority_and_arbitration_v0_1.md) | P0–P3; P3 drops under load. |
| [packet_sets_v0_1](../../nodetable/policy/packet_sets_v0_1.md) | Packet sets and eligibility. |
| [field_cadence_v0](../../../../areas/nodetable/policy/field_cadence_v0.md) | Cadence by field/packet. |
| [traffic_model_v0](traffic_model_v0.md) | Frame limits; delivery expectations. |
