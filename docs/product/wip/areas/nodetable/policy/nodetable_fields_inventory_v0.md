...
| **posFlags** | Position-valid / quality flags (uint8); 0 = not present or no fix. | [beacon_payload_encoding_v0.md](../contract/beacon_payload_encoding_v0.md) §4.2 | Position | Sent | Attached-to-Core | Yes (Tail-1: core_seq16) | B | Every Tail-1 | BeaconTail-1 (optional) | 1 | Optional Tail-1; receiver applies only if core_seq16 == lastCoreSeq. |
| **sats** | Satellite count when position valid (uint8); 0 = not present. | [beacon_payload_encoding_v0.md](../contract/beacon_payload_encoding_v0.md) §4.2 | Position | Sent | Attached-to-Core | Yes (Tail-1: core_seq16) | B | Every Tail-1 | BeaconTail-1 (optional) | 1 | Optional Tail-1; same receiver rule. |
