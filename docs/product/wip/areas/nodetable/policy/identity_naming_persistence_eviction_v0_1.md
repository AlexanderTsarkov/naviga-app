# NodeTable — Identity, Naming, Persistence & Eviction (S03 block v0.1)

**Status:** WIP. Frozen block for S03. **Parent:** [#351](https://github.com/AlexanderTsarkov/naviga-app/issues/351), [#352](https://github.com/AlexanderTsarkov/naviga-app/issues/352), [#364](https://github.com/AlexanderTsarkov/naviga-app/issues/364).
...
- **Target (v1, planned):** Persistence of NodeTable snapshot to NVS; restore on boot; merge rules with incoming RX per policy (e.g. [restore-merge-rules-v0](restore-merge-rules-v0.md)). Eviction policy aligned with tiers (T0/T1/T2) and pin where applicable. Implemented via dedicated issues (see §7).
...
- [packet_sets_v0_1.md](packet_sets_v0_1.md) — Packet definitions v0.1.
- [tx_priority_and_arbitration_v0_1.md](tx_priority_and_arbitration_v0_1.md) — TX priority P0–P3.
- [source-precedence-v0.md](source-precedence-v0.md), [restore-merge-rules-v0.md](restore-merge-rules-v0.md), [persistence-v0.md](persistence-v0.md), [snapshot-semantics-v0.md](snapshot-semantics-v0.md) — Precedence, merge, retention tiers, snapshot content (reference only; no duplication here).
