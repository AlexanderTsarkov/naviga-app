# NodeTable — Seq / ref / payload version / link metrics (S03 block v0.1)

**Status:** WIP. Frozen S03 block for sequence, Core/Tail reference, payload-version handling, and link metrics. **Parent:** [#351](https://github.com/AlexanderTsarkov/naviga-app/issues/351), [#352](https://github.com/AlexanderTsarkov/naviga-app/issues/352).
...
- [presence_and_age_semantics_v0_1.md](presence_and_age_semantics_v0_1.md) — last_seen_ms, is_stale, presence.
- [packet_sets_v0_1.md](packet_sets_v0_1.md), [tx_priority_and_arbitration_v0_1.md](tx_priority_and_arbitration_v0_1.md) — Packets and TX.
- [link_metrics_v0](../../../../areas/nodetable/policy/link_metrics_v0.md) (canon) — rssiLast/snrLast policy.
