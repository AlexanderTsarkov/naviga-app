...
| Firmware policy | [areas/firmware/policy/boot_pipeline_v0.md](areas/firmware/policy/boot_pipeline_v0.md) | Doc | v0 | Boot pipeline A→B→C (HW bring-up, provision role+radio profile, start comms); invariants; Phase D pointer | field_cadence, radio_profiles_policy, encoding | [#214](https://github.com/AlexanderTsarkov/naviga-app/issues/214) | — | N | Boot pipeline phases + invariants; configured then verify/repair | IN | Ready |
| Firmware policy | [areas/firmware/policy/module_boot_config_v0.md](areas/firmware/policy/module_boot_config_v0.md) | Doc | v0 | E220/GNSS device-level boot config: parameter tables, verify-and-repair vs one-time init; NFC/power TBD | boot_pipeline_v0 | [#215](https://github.com/AlexanderTsarkov/naviga-app/issues/215) | — | N | Module boot verify/repair strategy; critical params every boot | IN | Ready |
| Firmware policy | [areas/firmware/policy/provisioning_interface_v0.md](areas/firmware/policy/provisioning_interface_v0.md) | Doc | v0 | Serial provisioning: role/radio get/set/reset, factory reset, status; persistence rules; boot pipeline interaction | boot_pipeline_v0, role_profiles_policy, radio_profiles_policy | [#221](https://github.com/AlexanderTsarkov/naviga-app/issues/221) | — | N | Serial provisioning for role + radio profile pointers; factory reset; one FW image for V1-A | IN | Candidate |
