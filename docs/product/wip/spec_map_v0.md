...
| Firmware policy | [areas/firmware/policy/boot_pipeline_v0.md](areas/firmware/policy/boot_pipeline_v0.md) | Doc | v0 | Boot pipeline A→B→C (HW bring-up, provision role+radio profile, start comms); invariants; Phase D pointer | field_cadence, radio_profiles_policy, encoding | [#214](https://github.com/AlexanderTsarkov/naviga-app/issues/214) | — | N | Boot pipeline v0; verify-and-repair vs one-time init | IN | Candidate |
| Firmware policy | [areas/firmware/policy/module_boot_config_v0.md](areas/firmware/policy/module_boot_config_v0.md) | Doc | v0 | E220/GNSS device-level boot config: parameter tables, verify-and-repair vs one-time init; NFC/power TBD | boot_pipeline_v0 | [#215](https://github.com/AlexanderTsarkov/naviga-app/issues/215) | — | N | Module boot config v0; not user radio profile (#211) | IN | Candidate |
