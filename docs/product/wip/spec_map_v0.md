...
| Domain policy | [areas/domain/policy/role_profiles_policy_v0.md](areas/domain/policy/role_profiles_policy_v0.md) | Doc | v0 | Role profiles: operational params (minIntervalSec, minDisplacementM, maxSilence10s); invariants; OOTB Person/Dog/Infra; default + user roles; first boot + factory reset | field_cadence, beacon_encoding, boot_pipeline | [#219](https://github.com/AlexanderTsarkov/naviga-app/issues/219) | — | N | OOTB Person/Dog/Infra operational defaults fixed; maxSilence10s encoding applied; role provisioning ready | IN | Ready |
