...
| Protocol research (archived S03 closeout) | Frame header vs payload version analysis | §2.1 (ootb_radio_v0 spec); §3.1 (codec constants); §6.1 (gap table) |
