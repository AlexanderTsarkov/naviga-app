...
/** Persistence-specific record size (#418 narrow subset). Not the 26-byte BLE record. */
constexpr size_t kNodeTableSnapshotRecordBytes = 40;
 ...
 * last_seq, last_rx_rssi, last_applied_tail_ref* to 0/false). Returns count of entries restored, or 0 on error.
 */
