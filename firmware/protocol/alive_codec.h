 ...
 */
inline size_t encode_alive_frame(const AliveFields& fields, uint8_t* out, size_t out_cap) {
 ...
 */
inline AliveDecodeError decode_alive_payload(const uint8_t* payload, size_t payload_len,
                                             AliveFields* out) {
